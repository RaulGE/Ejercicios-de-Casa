...
void InitGL(GLvoid)     // Inicializamos parametros
{
	...
	t_pedestal.LoadTGA("pedestal.tga");
	t_pedestal.BuildGLTexture();
	t_pedestal.ReleaseImage();
...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	renderBitmapCharacter(-11, 10.5, -14, (void *)font, "Texturas	mesa de Ajedrez");
	glEnable(GL_TEXTURE_2D);
...
int main(int argc, char** argv)   // Main Function
{
	...
	glutCreateWindow("Practica 8 mesa RaulGE"); // Nombre de la Ventana
